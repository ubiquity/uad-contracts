...
contract BondingV2 is CollectableDust, Pausable {
        ...
        whenNotPaused
    {
        ...
        console.log("sharesToRemove 0 %s", sharesToRemove);
        console.log("pendingLpReward 0 %s", pendingLpReward);
        ...
        console.log("pendingLpReward 6 %s", pendingLpReward);
        console.log("sharesToRemove 6 %s", sharesToRemove);
    ...
    {
        console.log(
            "function lpRewardForShares : accLpRewardPerShare = %s",
            accLpRewardPerShare
        );
