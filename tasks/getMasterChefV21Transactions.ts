...
import * as ABI from "../deployments/mainnet/MasterChefV2.json"; // Contract ABI
import {
  Transaction,
  EtherscanResponse,
...
const MASTERCHEF_CONTRACT_ADDRESS = "0xdae807071b5AC7B6a2a343beaD19929426dBC998";
const CONTRACT_GENESIS_BLOCK = 12595544;
const DEFAULT_OUTPUT_NAME = "masterchef_transactions.json";
...
async function fetchEtherscanBondingContract(
  ...
  return fetchEtherscanApi(
    generateEtherscanQuery(MASTERCHEF_CONTRACT_ADDRESS, startBlock, endBlock)
  );
}
...
task(
  "getMasterChefV21Transactions",
  "Extract the contract transactions from Etherscan API and save them to a file"
)
  .addPositionalParam(
    "path",
