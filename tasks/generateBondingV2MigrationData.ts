...
const BONDING_CONTRACT_ADDRESS = "0xC251eCD9f1bD5230823F9A0F99a44A87Ddd4CA38";
...
const DEFAULT_OUTPUT_NAME = "bondingv2_migration.json";
...
task(
  "generateBondingV2MigrationData",
  "Extract the staking state from the bonding contract V2"
)
  .addPositionalParam(
    "path",
