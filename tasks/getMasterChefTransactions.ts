...
import * as ABI from "../deployments/mainnet/MasterChef.json"; // Contract ABI
import {
  Transaction,
  EtherscanResponse,
...
const MASTERCHEF_CONTRACT_ADDRESS = "0x8fFCf9899738e4633A721904609ffCa0a2C44f3D";
