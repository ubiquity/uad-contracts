commit ddc5c1b7624f8390594c6c9855f69763f6501289
Author: Benjamin <benjamin.mateo@protonmail.com>
Date:   Tue Jul 27 18:33:31 2021 +0200

    feat(v2) migration test for lprewards correct tracking

diff --git a/contracts/MasterChefOriginal.sol b/contracts/MasterChefOriginal.sol
index 5c30329..b833519 100644
--- a/contracts/MasterChefOriginal.sol
+++ b/contracts/MasterChefOriginal.sol
...
commit 37af40dcf0170dfc168c56e8db61bbce646e578a
Author: Benjamin <benjamin.mateo@protonmail.com>
Date:   Fri Jul 23 16:36:28 2021 +0200

    fix(lint) solhint

diff --git a/contracts/MasterChefOriginal.sol b/contracts/MasterChefOriginal.sol
index eeb42c1..5c30329 100644
--- a/contracts/MasterChefOriginal.sol
+++ b/contracts/MasterChefOriginal.sol
...
+
     ...
     function add(
@@ -142,49 +169,6 @@ contract MasterChefOriginal is Ownable {
...
@@ -269,6 +253,23 @@ contract MasterChefOriginal is Ownable {
         user.rewardDebt = 0;
     }
